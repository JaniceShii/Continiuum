      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-lg bg-gradient-to-r from-[#f85149] to-[#da3633] px-4 py-2 text-sm font-medium text-white transition-all hover:shadow-lg hover:shadow-red-500/20 hover:-translate-y-0.5"
          >
            Run Stress Test
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="card p-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-[#58a6ff]/20 to-[#bc8cff]/20 border border-[#58a6ff]/30">
                  <svg
          ...
          <div className="card p-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-[#f85149]/20 to-[#da3633]/20 border border-[#f85149]/30">
                  <svg
          ...
          <div className="card p-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-[#d29922]/20 to-[#bb8009]/20 border border-[#d29922]/30">
                  <svg
          ...
          <div className="card p-6">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-[#30363d]/50 to-[#21262d]/50 border border-[#30363d]">
                  <svg
        ...
        <div className="card">
          <div className="border-b border-[#30363d] px-6 py-4">
            <h2 className="text-lg font-semibold text-[#f0f6fc]">Recent Incidents</h2>
          </div>
        ...
        <div className="card">
          <div className="border-b border-[#30363d] px-6 py-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-[#f0f6fc]">Active Servers</h2>
              <Link
                href="/servers"
                className="text-sm font-medium text-[#58a6ff] hover:text-[#79c0ff] transition-colors"
              >
                View all →
              </Link>
            </div>
            ...
            {servers.slice(0, 5).map((server) => (
              <div key={server.id} className="px-6 py-4">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      <p className="text-sm font-medium text-[#f0f6fc]">{server.name}</p>
                      <span
                  ...
                  <button
                    ...
                    className="rounded-lg bg-gradient-to-r from-[#58a6ff] to-[#bc8cff] px-3 py-1.5 text-xs font-medium text-white transition-all hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-0.5"
                  >
                    Reset
                  </button>
                </div>
